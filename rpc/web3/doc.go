...
package web3 implements bi-directional JSON-RPC 2.0 on multiple transports.
...
criteria:
 ...
 - method must have return types (web3.Subscription, error)

An example method:

 func (s *BlockChainService) NewBlocks(ctx context.Context) (web3.Subscription, error) {
 	...
 }
...
In any method handler, an instance of web3.Client can be accessed through the
